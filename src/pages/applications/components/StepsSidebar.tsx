...
export function StepsSidebar({ steps, currentStep }: StepsSidebarProps) {
    return (
        <aside className="w-full hidden lg:flex lg:w-80 shrink-0 bg-background border-r border-border text-foreground flex flex-col p-6 lg:p-8 lg:h-screen lg:sticky lg:top-0 lg:self-start">
